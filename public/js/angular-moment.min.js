...
! function() {
    ...
    function a(a, b) {
        return a.module("angularMoment", []).constant("angularMomentConfig", {
            ...
            this.preprocessors = {
                ...
                var e = b.locale(d);
                return a.isDefined(d) && c.$broadcast("amMoment:localeChanged"), e
    ...
    "function" == typeof define && define.amd ? define("angular-moment", ["angular", "moment"], a) : "undefined" != typeof module && module && module.exports ? a(angular, require("moment")) : a(angular, window.moment)
}();
